      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li>
          <a href="{{route('add_admin')}}">
            <i class="fa fa-dashboard"></i> <span>Tạo tài khoản Admin</span>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>QL.Catalogs</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('catalogs')}}"><i class="fa fa-circle-o"></i> Bảng điều khiển</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="">
            <i class="fa fa-dashboard"></i> <span>QL.Products</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('products')}}"><i class="fa fa-circle-o"></i> Bảng điều khiển</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('banner')}}"><i class="fa fa-circle-o"></i> Bảng điều khiển</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="">
            <i class="fa fa-dashboard"></i> <span>QL.Users</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('users')}}"><i class="fa fa-circle-o"></i> Bảng điều khiển</a></li>
          </ul>
        </li>
