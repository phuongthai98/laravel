  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        @endif -->
        <form action="{{route('searchPro')}}" method="POST" class="form-inline" role="form">
            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{$pros->content}}</td>
                  <td>
                    <img src="{{url('')}}/public/upload/products/{{$pros->image}}" width="60px" alt="">
                  </td>
                  <td>{{$pros->description}}</td>
                  <td>{{$pros->created_date}}</td>
                  <td>{{$pros->modified_date}}</td>
                  <td>
